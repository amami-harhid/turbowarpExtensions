...
((Scratch) => {
    ...
    const SAMPLE_SVG = `data:image/svg+xml,<svg version="1.1" id="_x31_0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="width: 256px; height: 256px; opacity: 1;" xml:space="preserve">
    ...
    class MotionMyExtensions {
        getInfo(){
            return {
                id: "MotionMyExtensions0011e",   // 拡張機能のID(重複不可)
                name: "ExMotion0011e",   // 表示文字列
